...
/**
 * Connector using the AND logic operator.<br>
 *
 * The connector has two boolean bounded input properties and one boolean bounded output property
 * which value will be the result of evaluating both input values with the AND logic operator.<br>
 *
 * @author deors
 * @version 1.0
 */
public final class ConnectorAnd
